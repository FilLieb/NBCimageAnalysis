...
save("C:/Users/liebs/VSCodeProjects/NBCimageAnalysis/training/images/" + image + "-" + n + ".tif");
...
selectWindow(image + "-" + n + ".tif");
run("Select None");
save("C:/Users/liebs/VSCodeProjects/NBCimageAnalysis/training/masks/" + image + "-" + n + ".tif");
roiManager("reset");